...
class ProductosController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Medidas', 'Familias', 'Users'],
        ];
    ...
    public function add()
    {
        ...
        $medidas = $this->Productos->Medidas->find('list', ['limit' => 200])->all();
        $familias = $this->Productos->Familias->find('list', ['limit' => 200])->all();
        $users = $this->Productos->Users->find('list', ['limit' => 200])->all();
        $this->set(compact('producto', 'medidas', 'familias', 'users'));
    }
